...
export default function StaffAttendanceHistoryPage() {
    ...
    const loadHistory = async () => {
        ...
        setLoading(true);
        try {
            const url = `${process.env.NEXT_PUBLIC_API_URL || "https://demo-school-soxa.onrender.com"}/attendance/staff/history?month=${month}&year=${year}${deptId ? `&department_id=${deptId}` : ''}`;
