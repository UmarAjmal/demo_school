...
export default function SystemConfigPage() {
    ...
    const handleCreateBackup = async () => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-school-soxa.onrender.com"}/system/backups/create`, { method: 'POST' });
            const data = await res.json();
            if (res.ok) {
    ...
    const handleResetDatabase = async () => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://demo-school-soxa.onrender.com"}/settings/reset-database`, { method: 'POST' });
            const data = await res.json();
